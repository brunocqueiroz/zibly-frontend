        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h2 className="text-xl font-semibold inter-heading-normal">Responsible AI</h2>
              <p className="inter-text text-muted-foreground">
                No Zibly output is ever sent to public AI models. We use secure, enterprise-grade APIs, and all outputs are reviewed for privacy before delivery.
              </p>
            </div>
            {/* Incident Response */}
            <div className="flex flex-col items-center text-center space-y-3">
