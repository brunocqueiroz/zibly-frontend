          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/case-studies/hubspot">See HubSpot Case Study</Link>
              </Button>
            </div>
            <p className="text-sm text-gray-500">
              Used by marketing teams at Airbnb, Stripe, Notion, and 500+ companies
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-pink-50 rounded-lg p-8 md:p-12">
              <p className="text-xl md:text-2xl font-medium text-gray-900 mb-6">
                "Zibly is like having a data scientist, analyst, and strategist on demand. Last quarter, 
                we identified a channel opportunity that drove 40% of new revenue. Our team spends 
                time on creative strategy now, not spreadsheet gymnastics. Game changer."
              </p>
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-gray-300" />
                <div>
                  <p className="font-semibold">Sophie Martinez</p>
                  <p className="text-gray-600">CMO, Airbnb</p>
                </div>
              </div>
            </div>
          </div>
