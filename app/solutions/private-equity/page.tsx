          ...
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/case-studies/carlyle">See Carlyle Case Study</Link>
              </Button>
            </div>
            <p className="text-sm text-gray-500">
              Trusted by Blackstone, KKR, Carlyle, Apollo, and 50+ PE firms
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-indigo-50 rounded-lg p-8 md:p-12">
              <p className="text-xl md:text-2xl font-medium text-gray-900 mb-6">
                "Zibly fundamentally changed how we evaluate deals. We reviewed 3x more opportunities last 
                quarter and identified a margin expansion play that added $200M in exit value. What used 
                to take my team 2 weeks now takes 2 hours. This is the future of private equity."
              </p>
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-gray-300" />
                <div>
                  <p className="font-semibold">Michael Chen</p>
                  <p className="text-gray-600">PE Director, Carlyle</p>
                </div>
              </div>
            </div>
          </div>
