            ...
            <FadeIn>
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  <h2 className="inter-section-heading" style={{ fontSize: '56px', fontWeight: '400', lineHeight: '64px', letterSpacing: '-0.01em' }}>Our <GradientText>Story</GradientText></h2>
            ...
            <FadeIn delay={0.2}>
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <div className="text-center">
                  <h3 className="text-2xl inter-text-medium text-foreground">zibly ai</h3>
                  <p className="text-sm inter-text mt-1">Your AI Analyst</p>
                </div>
              </div>
            </FadeIn>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <SlideUp>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="inter-section-heading text-card-foreground" style={{ fontSize: '56px', fontWeight: '400', lineHeight: '64px', letterSpacing: '-0.01em' }}>The Zibly <GradientText>Difference</GradientText></h2>
              </div>
            </div>
          </SlideUp>
          <StaggerContainer className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
            <StaggerItem className="flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xl inter-heading-normal text-card-foreground">We Don't Do Chat</h3>
            ...
            <StaggerItem className="flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xl inter-heading-normal text-card-foreground">Quality Takes Time</h3>
                <p className="inter-text text-card-foreground">
            ...
            <StaggerItem className="flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="text-xl inter-heading-normal text-card-foreground">We Deliver Files</h3>
                <p className="inter-text text-card-foreground">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-4">
                <h2 className="inter-section-heading" style={{ fontSize: '56px', fontWeight: '400', lineHeight: '64px', letterSpacing: '-0.01em' }}>
                  Ready to <GradientText>Reclaim Your Time</GradientText>?
                </h2>
